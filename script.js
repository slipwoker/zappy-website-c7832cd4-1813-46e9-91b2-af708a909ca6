    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מורן ומתמטיקה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c7832cd4-1813-46e9-91b2-af708a909ca6',
                    name: data.name || '',
                    email: data.email || '',
